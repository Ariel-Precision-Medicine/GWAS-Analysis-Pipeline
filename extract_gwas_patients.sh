...
plink --bfile ukb_cal_chr${CHR}_v2 --keep case_control_ids_cp_only.txt --make-bed --out ukb_chr${CHR}_cponly 
#plink --bfile ukb_cal_chr${CHR}_v2 --keep case_control_ids_ap_only.txt --make-bed --out ukb_chr${CHR}_aponly 
