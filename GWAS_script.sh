...
--covar pancreatitis_vs_control_discrete_covars_matched.txt \
--qcovar pancreatitis_vs_control_quantitative_covars_matched.txt \
--out ukb_pancreatitis_vs_control_matched_out \
--thread-num 10 \
--maf 0.01 \
--autosome
# \--remove exclude.txt
